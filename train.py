...
def main():
    ...
    parser.add_argument('-opt', type=str, help='Path to option YAML file.', default=r'E:\mycode\ing\BDMD-Net\options\train\LOLv1.yml')
                ...
                if opt['model'] in ['sr', 'srgan'] and rank <= 0:  # image restoration validation
                    ...
                    if opt['dist']:
                        ...
                        for idx in range(rank, len(val_set), world_size):
                            ...
                            val_data['LQs2'].unsqueeze_(0)
                            val_data['LQs4'].unsqueeze_(0)
                            ...
                            sou_img2 = util.tensor2img(visuals['LQ2'])
                            sou_img4 = util.tensor2img(visuals['LQ4'])
                            rlt_img = util.tensor2img(visuals['rlt'])  # uint8
                            rlt_img2 = util.tensor2img(visuals['rlt2'])  # uint8
                            gt_img = util.tensor2img(visuals['GT'])  # uint8


                            save_img = np.concatenate([sou_img, sou_img2, sou_img4, rlt_img, ill_img, gt_img, rlt_img3, rlt_img2], axis=0)
