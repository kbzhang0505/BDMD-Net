...
parser.add_argument('-opt', type=str, required=True, help='Path to options YMAL file.',default='E:/mycode/ing/BDMD-Net/options/test/LOLv1.yml')
...
def main():
    ...
    save_folder = 'BDMD-Net/results/{}'.format(opt['name'])
